...
export default function Sidebar() {
  return (
    <>
      <aside className="w-[230px] h-[100vh] bg-white p-2">
        <nav className="flex flex-col gap-1 min-w-[200px] p-2 font-sans text-sm md:text-base font-normal text-gray-700">
          <div
            role="button"
